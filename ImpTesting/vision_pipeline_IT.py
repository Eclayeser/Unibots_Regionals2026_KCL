...
try:
    from . import ball_detector_runtime_IT as bdr
    from .ping_pong_detector_IT import extract_ping_pong
    from .steel_ball_detector_IT import extract_steel_floor_disturbance, FloorColorTracker
except ImportError:
    import ball_detector_runtime_IT as bdr
    from ping_pong_detector_IT import extract_ping_pong
    from steel_ball_detector_IT import extract_steel_floor_disturbance, FloorColorTracker
